...
function TestAnalysis() {
    ...
    useEffect(()=>{  
        ...
        axios.get(`${apiUrl}/freeseries/analysis/${allAnswers[0].questId}`)
        .then((resp) => {
    ...
    var handleQuestionNoClick = (index) => {
        ...
        isLoading = true ;
        setIsLoading(isLoading) ;
        axios.get(`${apiUrl}/freeseries/analysis/${questId}`)
        .then((resp) => {
            isLoading = false ;
            setIsLoading(isLoading) ;
            currentQuestionData = resp.data ;
            ...
            return (
                ...
                <div className="col-md-5">
                    ...
                    <tr>
                        ...
                        <td>
                            {marks+"  "} / {" "+parseFloat(testResult.length * marksPerQuestion)}   
                        </td>
                    </tr>  
                    </tbody>
                    </table>
