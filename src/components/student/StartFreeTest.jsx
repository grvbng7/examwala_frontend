...
function StartFreeTest(){ 
    ...
    var [currentQuestionData , setCurrentQuestionData ] = useState({id : "" ,  question : "" , o1 : "" , o2 : "" , o3 : "" , o4 : "" , imageName : "" }) ; 
    ...
    useEffect(() => { 
        ...
        setTestId(testId) ;        
        axios.get(`${apiUrl}/freeseries/${testId}`)
        .then((resp) => {
                    ...
                    axios.get(`${apiUrl}/freeseries/questdata/${questionIds[0]}`)
                    .then((resp) => {
    ...
    var submitTest = (autosubmit) => {
        ...
        axios.post(`${apiUrl}/freeseries/submittest/${testId}`, allAnswers )
        .then((resp)=>{
            ...
            setSubmitTestLoading(submitTestLoading) ; 
            nav("/freetest/analysis", {state : { "marksPerQuestion" : location.state.marksPerQuestion ,   testId : testId ,  allAnswers : allAnswers , response : resp.data }} ) ;
        })  //end of then()
    ...
    var handleQuestionNoClick = (index) =>  {
        ...
        axios.get(`${apiUrl}/freeseries/questdata/${questId}`)
        .then((resp) => {
            isLoading = false ;
            setIsLoading(isLoading) ;
            currentQuestionData = resp.data ;
